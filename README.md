...
In this task, we aim to extract the state of the birthplaces of different professional Indian football players who had and are playing for the country. For this purpose, we first scrapped a website. Please click (https://www.national-football-teams.com/)[here] to visit the website. The code for scraping is available in the scraping.py file. Our main objective was to find the cumulative number of states which the players are coming from. Note that, one player can be present in multiple years. We don't drop this players as they contribute to the statistical calculations in each individual years. To this end, we have created three choropleths maps of players from 2002-2013, 2014-2019 and 2021-2023, repectively. There was no data for 2020. Below we provide the final table of the players and their respective birthplaces and states.  
